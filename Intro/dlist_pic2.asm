...
dl_start
    ...
    :2 dta DL_MODE_40x24T5                                      ; raw 4
    dta DL_DLI + DL_MODE_40x24T5                                ; raw 4
    :3 dta DL_MODE_40x24T5                                      ; raw 5
    dta DL_DLI + DL_MODE_40x24T5                                ; raw 5
    :2 dta DL_MODE_40x24T5                                      ; raw 6
    dta DL_DLI + DL_MODE_40x24T5                                ; raw 6
